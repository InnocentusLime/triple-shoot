...
pub static WAVES: [WaveCfg; 9] = [
    WaveCfg {
        ...
        enemies_wait: 1.0,
        enemies: [SpawnEntryCfg::disabled(), SpawnEntryCfg::disabled()],
        max_enemies_on_screen: 0,
    },
    WaveCfg {
        is_pickup_wave: false,
        pickup_wait: 1.0,
        pickups: [SpawnEntryCfg::disabled()],
        max_pickups_on_screen: 0,
        enemies_wait: 1.0,
        enemies: [SpawnEntryCfg { wait: 2.0, weight: 1, quota: 3 }, SpawnEntryCfg::disabled()],
    ...
    WaveCfg {
        ...
        enemies_wait: 1.0,
        enemies: [SpawnEntryCfg { wait: 1.0, weight: 1, quota: 5 }, SpawnEntryCfg::disabled()],
    ...
    WaveCfg {
        ...
        max_pickups_on_screen: 0,
        enemies_wait: 0.8,
        enemies: [SpawnEntryCfg { wait: 0.8, weight: 1, quota: 4 }, SpawnEntryCfg::disabled()],
        max_enemies_on_screen: 1,
    },
    WaveCfg {
        is_pickup_wave: true,
        pickup_wait: 0.2,
        pickups: [SpawnEntryCfg { wait: 0.1, weight: 1, quota: 2 }],
        max_pickups_on_screen: 1,
        enemies_wait: 1.0,
        enemies: [SpawnEntryCfg::disabled(), SpawnEntryCfg::disabled()],
        max_enemies_on_screen: 0,
    ...
    WaveCfg {
        ...
        max_pickups_on_screen: 0,
        enemies_wait: 0.8,
        enemies: [SpawnEntryCfg { wait: 0.8, weight: 1, quota: 8 }, SpawnEntryCfg::disabled()],
        max_enemies_on_screen: 2,
    },
    WaveCfg {
        is_pickup_wave: false,
        ...
        enemies: [
            ...
            SpawnEntryCfg { wait: 3.0, weight: 1, quota: 12 },
        ],
    ...
    WaveCfg {
        ...
        max_pickups_on_screen: 0,
        enemies_wait: 1.0,
        enemies: [SpawnEntryCfg { wait: 0.8, weight: 1, quota: 6 }, SpawnEntryCfg::disabled()],
        max_enemies_on_screen: 1,
    },
];
